...
@section('content')
<form method="POST" action="{{ route(activeGuard().'.country.regions.store',$Country) }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="number" name="delivery_cost" id="delivery_cost" class="form-control" required>
        </div>
        <div class="col-md-6">

...
{{--        </div>--}}
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <textarea name="desc_ar" placeholder="@lang('trans.desc_ar')" class="form-control" required>{!! $Model['desc_ar'] !!}</textarea>
        </div>
        <div class="col-md-6 col-sm-12">
            <label >@lang('trans.desc_en')</label>
            <textarea name="desc_en" placeholder="@lang('trans.desc_en')" class="form-control" required>{!! $Model['desc_en'] !!}</textarea>
        </div>
